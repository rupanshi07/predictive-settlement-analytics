...
score risk — it explains *why* a trade is flagged, ranks the specific
...
Most student ML projects stop at "train a classifier, report accuracy."
This one deliberately adds two layers that most tutorials skip, because
...
- **XGBoost over deep learning**: tabular data, modest feature count —
...
- ROC-AUC: ~0.80, PR-AUC (average precision): ~0.51 on an ~12% positive
  class base rate — evaluated on a held-out test set.
